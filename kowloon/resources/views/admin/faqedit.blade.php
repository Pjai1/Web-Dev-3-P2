...
<div class="faq-page">
    <div class="main-content">
        ...
        <h1>Faq Update</h1>
        {!! Form::open(['url' => '/admin/faqs/'.$faq->id.'/edit']) !!}
				{{ Form::token() }}
				<div class="form-group">
					{{ Form::label('nl_question', 'nl_question') }}
					{{ Form::text('nl_question', $faq->nl_question, ['class' => 'form-control']) }}
				...
				<div class="form-group">
					...
					{{ Form::text('fr_question', $faq->fr_question, ['class' => 'form-control']) }}
				...
				<div class="form-group">
					...
					{{ Form::text('nl_answer', $faq->nl_answer, ['class' => 'form-control']) }}
				...
				<div class="form-group">
					...
					{{ Form::text('fr_answer', $faq->fr_answer, ['class' => 'form-control']) }}
				...
				@foreach ($products as $product)
					<div class="form-group">
						{{ Form::checkbox('products[]', $product->id, ($faq->products->contains($product->id) ? 'true' : ''))}}
